...
namespace EDIProcessingApp.Infrastructure.Migrations
{
    ...
    [Migration("20250811214859_AddEdiTransactionTypes")]
    partial class AddEdiTransactionTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EDIProcessingApp.Core.Entities.EdiFile", b =>
                {
                    ...
                    b.Property<int?>("EdiTransactionTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EdiTransactionTypeId");
            ...
            modelBuilder.Entity("EDIProcessingApp.Core.Entities.EdiTransactionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EdiTransactionTypes", "edi");
            ...
            modelBuilder.Entity("EDIProcessingApp.Core.Entities.EdiFile", b =>
                {
                    ...
                    b.HasOne("EDIProcessingApp.Core.Entities.EdiTransactionType", "EdiTransactionType")
                        .WithMany("EdiFiles")
                        .HasForeignKey("EdiTransactionTypeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Account");

                    b.Navigation("EdiTransactionType");
                });
